    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                next_corners = []
                for i, corner_pos in enumerate(self.corners):
                    next_corners.append(corner_pos == next_pos or corners[i])
                
                next_state = (next_pos, tuple(next_corners))
...
#python3 pacman.py -l tinyCorners -p AStarCornersAgent -z 0.5
...
class FoodSearchProblem:
    ...
    def getCostOfActions(self, actions):
        ...
        for action in actions:
            ...
            cost += 1
        return cost
#python3 pacman.py -l mediumDottedMaze -p AStarFoodSearchAgent -z 0.5
